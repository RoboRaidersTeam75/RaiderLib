...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveConstants constants, MotorType type, MotorConfiguration driveConfig, MotorConfiguration angleConfig){
    ...
    public SwerveModule(int moduleNumber, SwerveConstants constants, MotorType driveType, MotorConfiguration driveConfig, MotorType angleType, MotorConfiguration angleConfig) {
        m_moduleNumber = moduleNumber;
    ...
    public void setDesiredState(SwerveModuleState desiredState) {
        ...
        m_angleMotor.setPosition(Conversions.degreesToRotations(angle.getDegrees(), m_constants.angleGearRatio));
        lastAngle = angle;
    }

    public Rotation2d getAngle() {
        return Rotation2d.fromDegrees(Conversions.rotationsToDegrees(m_angleMotor.getPosition(), m_constants.angleGearRatio));
    }

    public SwerveModuleState getState() {
        // TODO: again, lack of SwerveConstants is stopping us from being able to do this (driveGearRatio, wheelCircumference)
