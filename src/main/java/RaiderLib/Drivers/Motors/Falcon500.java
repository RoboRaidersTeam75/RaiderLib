...
public class Falcon500 implements Motor {
   ...
   */
    ...
    private void configMotor(MotorConfiguration config){
      ...
      falconConfig.ClosedLoopRamps.DutyCycleClosedLoopRampPeriod = config.rampRates.closedLoopRampRateSeconds;
      falconConfig.OpenLoopRamps.DutyCycleOpenLoopRampPeriod = config.rampRates.openLoopRampRateSeconds;
      ...
      falconConfig.CurrentLimits.SupplyCurrentThreshold = config.currentConfigs.SupplyCurrentThresholdAmps;
      falconConfig.CurrentLimits.SupplyTimeThreshold = config.currentConfigs.SupplyCurrentThresholdSeconds;
      ...
      falconConfig.MotorOutput.Inverted = config.generalConfigs.motorInvert ? InvertedValue.Clockwise_Positive : InvertedValue.CounterClockwise_Positive;
      falconConfig.MotorOutput.NeutralMode = config.generalConfigs.brakeModeEnabled ? NeutralModeValue.Brake : NeutralModeValue.Coast;

      falconConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold = config.softLimits.forwardSoftLimitRotations;
      falconConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold = config.softLimits.forwardSoftLimitRotations;
      falconConfig.SoftwareLimitSwitch.ForwardSoftLimitEnable = config.softLimits.enableForwardSoftLimit;
      falconConfig.SoftwareLimitSwitch.ReverseSoftLimitEnable = config.softLimits.enableForwardSoftLimit;
