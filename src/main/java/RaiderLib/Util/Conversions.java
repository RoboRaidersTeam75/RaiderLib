...
public class Conversions {
   ...
   * @return Mechanism Position: (in Degrees)
   */
  public static double rotationsToDegrees(double motorRot, double gearRatio) {
   ...
   */
  public static double degreesToRotations(double mechDeg, double gearRatio) {
   ...
   */
  public static double RPSToRPM(double motorRPS, double gearRatio) {
   ...
   */
  public static double RPMToRPS(double mechRPM, double gearRatio) {
   ...
   */
  public static double RPSToMPS(double motorRPS, double circumference, double gearRatio) {
   ...
   * @return Motor Velocity: (in Rotations per Second)
   */
  public static double MPSToRPS(double wheelRPM, double circumference, double gearRatio) {
   ...
   */
  public static double rotationsToMeters(double motorRot, double circumference, double gearRatio) {
