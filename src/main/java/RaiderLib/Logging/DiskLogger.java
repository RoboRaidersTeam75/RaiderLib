    ...
    for (Map.Entry<String, LoggedValue> field : logTable.updatesMap().entrySet()) {
      ...
      switch (field.getValue().type) {
        ...
        case Boolean:
          ...
          break;
        case BooleanArray:
          log.appendBooleanArray(
              id, (boolean[]) field.getValue().getLogValue(), logTable.timestamp());
          break;
        case Integer:
        ...
        case Double:
          ...
          break;
        case DoubleArray:
          log.appendDoubleArray(
              id, (double[]) field.getValue().getLogValue(), logTable.timestamp());
          break;
        case String:
          log.appendString(id, (String) field.getValue().getLogValue(), logTable.timestamp());
          break;
        case StringArray:
          log.appendStringArray(
              id, (String[]) field.getValue().getLogValue(), logTable.timestamp());
          break;
          /*
        ...
        case SwerveModulePosition:
          ...
          double[] positionArray = {
            1, position.distanceMeters, position.angle.getRadians()
          }; // [distance,
          // θ]
        ...
        case SwerveModuleState:
          ...
          double[] stateArray = {
            2, state.speedMetersPerSecond, state.angle.getRadians()
          }; // [speed, θ]
