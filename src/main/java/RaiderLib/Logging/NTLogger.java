        ...
        for (Map.Entry<String, LoggedValue> field : logTable.updatesMap().entrySet()) {
            ...
            if (field.getValue().sendToNT) {
                ...
                if (field.getValue().type == LoggableType.Pose2d) {
                    StructArrayPublisher<Pose2d> publisher = (StructArrayPublisher<Pose2d>) publishers.get(key);
                    if (publisher == null) {
                    ...
                    StructArrayPublisher<SwerveModulePosition> publisher = (StructArrayPublisher<SwerveModulePosition>) publishers.get(key);
                    if (publisher == null) {
                    ...
                    StructArrayPublisher<SwerveModuleState> publisher = (StructArrayPublisher<SwerveModuleState>) publishers.get(key);
                    if (publisher == null) {
