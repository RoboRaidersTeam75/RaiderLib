...
public class Logger {
  ...
  private static StringPublisher messagePublisher =
      NetworkTableInstance.getDefault().getTable("Messages").getStringTopic("messages").publish();
  ...
  public static void updateQueue() {
    try {
      ...
      DriverStation.reportError(
          "Logging queue capacity exceeded, data is no longer being logged.", false);
    }
  }
